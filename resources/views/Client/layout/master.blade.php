                    ...
                    <ul class="list hidden-sm">
                        ...
                        <li class="list-item list-item-has-children mega-menu mega-menu-col-3">
                            ...
                            <ul class="sub-menu nav">
                                ...
                                <li class="list-item">
                                    <a href="#">
                                        <img src="/client/assets/img/theme/mega-menu.jpg" alt="">
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <a class="main-slider-slide" href="#">
                                    <img src="/client/assets/img/main-slider/img-slider-2/1.jpg" alt="" class="img-fluid">
                                </a>
                            </div>
                            <div class="carousel-item">
                                <a class="main-slider-slide" href="#">
                                    <img src="/client/assets/img/main-slider/img-slider-2/2.jpg" alt="" class="img-fluid">
                                </a>
                            </div>
                            <div class="carousel-item">
                                <a class="main-slider-slide" href="#">
                                    <img src="/client/assets/img/main-slider/img-slider-2/3.jpg" alt="" class="img-fluid">
                                </a>
                            </div>
                            <div class="carousel-item">
                                <a class="main-slider-slide" href="#">
                                    <img src="/client/assets/img/main-slider/img-slider-2/4.jpg" alt="" class="img-fluid">
                                </a>
                            </div>
                            <div class="carousel-item">
                                <a class="main-slider-slide" href="#">
                                    <img src="/client/assets/img/main-slider/img-slider-2/5.jpg" alt="" class="img-fluid">
                                </a>
                            </div>
                            <div class="carousel-item">
                                <a class="main-slider-slide" href="#">
                                    <img src="/client/assets/img/main-slider/img-slider-2/6.jpg" alt="" class="img-fluid">
                                </a>
                            </div>
                            <div class="carousel-item">
                                <a class="main-slider-slide" href="#">
                                    <img src="/client/assets/img/main-slider/img-slider-2/7.jpg" alt="" class="img-fluid">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="product-carousel carousel-lg owl-carousel owl-theme">
                            <div class="item">
                                <div class="amazing-product text-center pt-5">
                                    <a href="#">
                                        <img src="/client/assets/img/theme/amazing-1.png" alt="">
                                    </a>
        ...
        <div class="container main-container">
                ...
                <div class="col-xl-2 col-lg-3 hidden-lg pr-0">
                    <div class="widget-suggestion dt-sn border pt-3 mt-3">
                        <div class="widget-suggestion-title">
                            <img src="/client/assets/img/theme/suggestion-title.png" alt="">
                        </div>
                        <div id="progressBar">
            ...
            <div class="row mt-3 mb-5">
                <div class="col-sm-6 col-12 mb-2">
                    <div class="widget-banner">
                        <a href="#">
                            <img src="/client/assets/img/banner/medium-banner-1.jpg" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-sm-6 col-12 mb-2">
                    <div class="widget-banner">
                        <a href="#">
                            <img src="/client/assets/img/banner/medium-banner-2.jpg" alt="">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="container main-container">
            ...
            <div class="row mt-3 mb-5">
                <div class="col-md-3 col-sm-6 col-6 mb-2">
                    <div class="widget-banner">
                        <a href="#">
                            <img src="/client/assets/img/banner/small-banner-5.jpg" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-6 mb-2">
                    <div class="widget-banner">
                        <a href="#">
                            <img src="/client/assets/img/banner/small-banner-6.jpg" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-6 mb-2">
                    <div class="widget-banner">
                        <a href="#">
                            <img src="/client/assets/img/banner/small-banner-7.jpg" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-6 mb-2">
                    <div class="widget-banner">
                        <a href="#">
                            <img src="/client/assets/img/banner/small-banner-8.jpg" alt="">
                        </a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="category-slider owl-carousel">
                                <div class="item">
                                    <a href="#" class="promotion-category">
                                        <img src="/client/assets/img/category/notebook-computer.png" alt="">
                                ...
                                <div class="item">
                                    <a href="#" class="promotion-category">
                                        <img src="/client/assets/img/category/lifeline-in-a-heart-outline.png" alt="">
                                ...
                                <div class="item">
                                    <a href="#" class="promotion-category">
                                        <img src="/client/assets/img/category/repair-tools.png" alt="">
                                ...
                                <div class="item">
                                    <a href="#" class="promotion-category">
                                        <img src="/client/assets/img/category/hanbok.png" alt="">
                                ...
                                <div class="item">
                                    <a href="#" class="promotion-category">
                                        <img src="/client/assets/img/category/sofa.png" alt="">
                                ...
                                <div class="item">
                                    <a href="#" class="promotion-category">
                                        <img src="/client/assets/img/category/school-material.png" alt="">
                                ...
                                <div class="item">
                                    <a href="#" class="promotion-category">
                                        <img src="/client/assets/img/category/baby-girl.png" alt="">
                                ...
                                <div class="item">
                                    <a href="#" class="promotion-category">
                                        <img src="/client/assets/img/category/adventurer.png" alt="">
            ...
            <div class="row mt-3 mb-5">
                <div class="col-12">
                    <div class="widget-banner">
                        <a href="#">
                            <img src="/client/assets/img/banner/large-banner.jpg" alt="">
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-horizontal-product border-bottom rounded-0">
                                    <div class="card-horizontal-product-thumb">
                                        <a href="#">
                                            <img src="/client/assets/img/products/017.jpg" alt="">
                                        </a>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card-horizontal-product border-bottom rounded-0">
                                    <div class="card-horizontal-product-thumb">
                                        <a href="#">
                                            <img src="/client/assets/img/products/020.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="card-horizontal-product-content">
                                        <div class="card-horizontal-product-title">
                            ...
                            <div class="col-12">
                                <div class="card-horizontal-product border-bottom rounded-0">
                                    <div class="card-horizontal-product-thumb">
                                        <a href="#">
                                            <img src="/client/assets/img/products/014.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="card-horizontal-product-content">
                                        <div class="card-horizontal-product-title">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-horizontal-product border-bottom rounded-0">
                                    <div class="card-horizontal-product-thumb">
                                        <a href="#">
                                            <img src="/client/assets/img/products/016.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="card-horizontal-product-content">
                                        <div class="card-horizontal-product-title">
                            ...
                            <div class="col-12">
                                <div class="card-horizontal-product border-bottom rounded-0">
                                    <div class="card-horizontal-product-thumb">
                                        <a href="#">
                                            <img src="/client/assets/img/products/018.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="card-horizontal-product-content">
                                        <div class="card-horizontal-product-title">
                            ...
                            <div class="col-12">
                                <div class="card-horizontal-product border-bottom rounded-0">
                                    <div class="card-horizontal-product-thumb">
                                        <a href="#">
                                            <img src="/client/assets/img/products/015.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="card-horizontal-product-content">
                                        <div class="card-horizontal-product-title">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="brand-slider carousel-lg owl-carousel owl-theme">
                            <div class="item">
                                <img src="/client/assets/img/brand/1076.png" class="img-fluid" alt="">
                            </div>
                            <div class="item">
                                <img src="/client/assets/img/brand/1078.png" class="img-fluid" alt="">
                            </div>
                            <div class="item">
                                <img src="/client/assets/img/brand/1080.png" class="img-fluid" alt="">
                            </div>
                            <div class="item">
                                <img src="/client/assets/img/brand/2315.png" class="img-fluid" alt="">
                            </div>
                            <div class="item">
                                <img src="/client/assets/img/brand/1086.png" class="img-fluid" alt="">
                            </div>
                            <div class="item">
                                <img src="/client/assets/img/brand/5189.png" class="img-fluid" alt="">
                            </div>
                            <div class="item">
                                <img src="/client/assets/img/brand/1000006973.png" class="img-fluid" alt="">
                            </div>
                            <div class="item">
                                <img src="/client/assets/img/brand/1000014452.jpg" class="img-fluid" alt="">
                            </div>
                        </div>
                    </div>
                    <!-- End Product-Slider -->
